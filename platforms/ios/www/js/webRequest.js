...
//            <a href="#" onclick="window.open('http://www.kidzout.com', '_system');">www.kidzout.com</a>
            ...
            if(data.nodes[x].node.type=="Product"){
                $(".scrollul").append("<li class='scrollli'><h1 id='companyName'>"+title+"</h1><p class='pBtn'><button onclick='sharetoFVnormal();'><img src='img/share%20alt.png'/></button>&nbsp;<button onclick='clickFav("+nid+")'><img src='img/fav-alt.png' id='shareImg'/></button>&nbsp;<button onclick='replyOnClick("+nid+")'><img src='img/message-alt.png'/></button></p><br><p><img id='productImg' src='"+ imageUrl +"'/></p><p class='seperator'>&nbsp;</p><br><span class='description' id='productdetails'>"+ desc +"</span><p class='seperator'>&nbsp;</p><h2>Unique Selling Point</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+unidsellingpoint+"</span><br><h2>Customer References</h2><p class='h2seperator'>&nbsp;</p><span class='description'>" +custRef+"</span><h2>Brochures</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+brochure+"</span><br><h2>Tags</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+tags+"</span><br><h2>Technology Area</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+techarea+"</span><br><h2>Platforms</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+platform+"</span><br><h2>Product Requirement</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+prequirement+"</span><br><h2>Market</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+market+" </span><br><h2>Industry</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+industry+"</span><br><h2>Gallery</h2><p class='h2seperator'>&nbsp;</p><br><span class='description'></span><p><br><br></p></li>");
            }
            else if(data.nodes[x].node.type=="Service"){
                $(".scrollul").append("<li class='scrollli'><h1 id='companyName'>"+title+"</h1><p class='pBtn'><button onclick='sharetoFVnormal();'><img src='img/share%20alt.png'/></button>&nbsp;<button onclick='clickFav("+nid+")'><img src='img/fav-alt.png' id='shareImg'/></button>&nbsp;<button onclick='replyOnClick("+nid+")'><img src='img/message-alt.png'/></button></p><br><p><img id='productImg' src='"+imageUrl+"'/></p><p class='seperator'>&nbsp;</p><br><span class='description' id='productdetails'>"+desc+"</span><span class='seperator'>&nbsp;</p><h2>Customer References</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+custRef+"</span><br><h2>Brochures</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+brochure+"</span><br><h2>Tags</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+tags+"</span><br><h2>Platforms</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+platform+"</span><br><h2>Service Requirement</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+srequirement+"</span><br><h2>Market</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+market+"</span><br><h2>Service Category</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+scategory+"</span><br><h2>Service Sub Category</h2><p class='h2seperator'>&nbsp;</p><span class='description'>"+ssubcat+"</span><br><h2>Gallery</h2><p class='h2seperator'>&nbsp;</p><br><span class='description'></span><p><br><br></p></li>");
            }
