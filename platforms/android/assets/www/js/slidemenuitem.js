...
$("#slidemenu").append("<li><label class='itemlabel'><img src='img/listing.png' class='menuitemimg' />Listings</label></li>");
...
$("#slidemenu").append("<li><label class='itemlabel'><img src='img/logout.png' class='menuitemimg' />Logout</label></li>");
